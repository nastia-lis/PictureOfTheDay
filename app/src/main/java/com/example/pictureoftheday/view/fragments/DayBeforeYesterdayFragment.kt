...
import com.example.pictureoftheday.databinding.DayBeforeYesterdayFragmentBinding
...
class DayBeforeYesterdayFragment : Fragment() {
    ...
    private var _binding: DayBeforeYesterdayFragmentBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = DayBeforeYesterdayFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
